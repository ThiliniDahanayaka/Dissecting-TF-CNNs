...
#model_names = ['DF_onAWF_data_model1', 'DF_onAWF_data_mode2', 'DF_onAWF_data_mode3', 'DF_onAWF_data_mode4', 'DF_onAWF_data_mode5' ]
...
#plt.title('ECDF plots of normalized weights of DF models trained on AWF dataset', fontdict=font)
plt.savefig("archive/ECDF_of_df_on_DFdataset_norm.png", bbox_inches='tight')
...
for model_path in model_names:
    ...
    plt.scatter(x, y)
plt.legend(['Model 1', 'Model 2', 'Model 3', 'Model 4', 'Model 5'], fontsize=24, loc='lower right')
plt.xlabel("Value of weight", fontdict=font)
plt.ylabel('Percentage of weights', fontdict=font)
plt.xticks(fontsize=20)
plt.yticks(fontsize=20)
#plt.title('ECDF plots of normalised weights of DF models trained on DF dataset', fontdict=font)
plt.savefig("archive/ECDF_of_df_on_AWFdataset_normalised_weights.png")
'''
