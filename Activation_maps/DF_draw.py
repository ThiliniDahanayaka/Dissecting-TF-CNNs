...
from utility_DF import LoadDataNoDefCW
...
def create_model(layer_name):
    model = load_model("/home/sec-user/thilini/1.PAPER_FINAL/DF_CNN_model_training/DF_model/models/DF_onDF_data_model1")
...
with open('DF_L5_filter_out.txt', 'wb') as file:
